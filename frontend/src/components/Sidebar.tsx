      ...
      <nav className="mt-6">
        ...
        <div className="mt-8 px-3">
          <div className="border-t border-gray-200 pt-4">
            ...
            <button className="flex items-center space-x-3 px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors duration-200 w-full">
